...
To run the different scenarios, you must first join each scenario's polling data with the historic polling data. There is a helper script written for this purpose in the `data/` directory [here](https://github.com/AEJaspan/ElectionForecasting/blob/main/ElectionForecasting/data/combine_scenarios_data.py).
